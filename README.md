...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-genealogy-discovery?sort=semver)](https://github.com/liberusoftware/module-genealogy-discovery/releases/latest) [![Tests](https://github.com/liberusoftware/module-genealogy-discovery/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-genealogy-discovery/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-genealogy-discovery
```
...
<a href="https://github.com/liberusoftware/module-genealogy-discovery/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-genealogy-discovery" alt="Contributors to liberusoftware/module-genealogy-discovery">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-genealogy-discovery/graphs/contributors).
